...
?>
  <div id="wrap">
    <div id="page-heading">
      ...
      <h1>@lang("label.adSettings")</h1>
      <hr>
    </div>
    <div class="container">
        <form name="settings_form" class="common-form" id="settings_form" method="post" action="{{route('saveSettings')}}" enctype="multipart/form-data">
            <div class="row">
        <div class="toggle-wrap">
          <div class="toggle-text"><p>@lang("label.allowGroupAdmin")</p></div>
          <div class="toggle-button">
            ...
            <label class="slider-viewport" for="allow_admin">
              <div class="slider">
                ...
                <div class="slider-content left"><span>@lang("label.No")</span></div>
                <div class="slider-content right"><span>@lang("label.Yes")</span></div>
              </div>
            </label>
          </div>
        </div>
        <div class="toggle-wrap">
          <div class="toggle-text"><p>@lang("label.Allowanonymousposting")</p></div>
          <div class="toggle-button">
        ...
        <div class="toggle-wrap">
          <div class="toggle-text"><p>@lang("label.adCompany Logo"):</p></div>
          <div class="company-wrap">
            ...
            <div class="btn-wrap">
              <div class="upload-btn-wrapper">
                <button class="btn st-btn saveSettings">@lang("label.UploadNew")</button>
...
@push('javascripts')
    <script type="text/javascript">
        function saveSettings(){
            ...
            $.ajax({
                url: SITE_URL+'/'+LANG+ '/saveSettings',
                type:"post",
                cache: false,
                contentType: false,
                processData: false,
