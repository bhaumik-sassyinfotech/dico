                                            ...
                                            <div class="btn-toolbar form-group clearfix">
                                                <ul class="nav nav-tabs">
                                                    <li class="active"><a href="#allgroups" onclick="groupGrid(2)" data-toggle="tab" data-order="desc2"
                                                                    ...
                                                                    aria-hidden="true"></i><span class=" hidden-xs">@lang("label.AllGroups")</span></a>
                                                    </li>
                                                    <li style="display: none;" class=""><a href="#mygroups" onclick="groupGrid(1)" data-toggle="tab" data-order="desc1" data-sort="default"
                                                      ...
                                                      class=" hidden-xs">@lang("label.Mygroups")</span></a></li>
                                                </ul>
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="panel panel-info">
                                                                    <div class="panel-heading trophy">
                                                                        <h4 class="icon">@lang("label.GroupsListing")</h4>
                                                                        <div class="pull-right">
                                                                            <a href="{{route('setting')}}"><img src="{{asset('assets/img/settings-icon.png')}}" alt="settings"></a>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="select notice-left">
                                                                    <select name="slct" id="slct">
                                                                        <option value="delete">@lang("label.Delete")</option>
                                                                    </select>
                                                                </div>
                                                                <div class="action notice-left" style="padding: 0px 10px; ">
                                                                   <input type="button" name="" class="st-btn multiple-action" value="@lang('label.adSubmit')">
                                                                </div>
                                                                </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <label>@lang("label.AddUserToTheGroup"):</label> 
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <h4 class="modal-title">@lang("label.Adduserbyemailaddress"):</h4>
                                                        <input type="text" name="user_email" id="user_email" placeholder="@lang('label.Typeusernameoremailid')">
                                                    </div> 
                                                    <div class="form-group">
                                                        <div class="btn-wrap-div">
                                                            <input class="st-btn" name="addGroupMember" id="addGroupMember" type="button" value="@lang('label.Add')">
