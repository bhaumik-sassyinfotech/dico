                                        ...
                                        <div class="border-tabs">
                                            <div class="btn-toolbar form-group clearfix">
                                                <ul class="nav nav-tabs">
                                                    ...
                                                    <li class=""><a href="#employee" onclick="groupGrid(1)" data-toggle="tab" data-order="desc1" data-sort="default"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <ul class="gallery list-unstyled" id="display-grid">
                                            ...
                                            <div class="hide-table none">
                                                <div tabindex="5000" class="tab-pane active employee-tab" id="employee">
                                                    <div class="container">
