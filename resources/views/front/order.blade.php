...
<div class="row">
	<div class="col-md-6 col-md-offset-3">
		{!! Form::open(['url' => '/order','method' => 'post','data-parsley-validate','id' => 'payment-form']) !!}
		 <div class="form-group" id="first-name-group">
		  ...
		  <div class="form-group" id="cc-group">
			  ...
			  {!! Form::text('card_number', 'card_number', [
		  ...
		  <div class="row">
			<div class="col-md-4">
			  <div class="form-group" id="exp-m-group">
				  ...
				  {!! Form::selectMonth('ex_month','ex_month', [
			...
			<div class="col-md-4">
			  <div class="form-group" id="exp-y-group">
				  ...
				  {!! Form::selectYear('ex_year', date('Y'), date('Y') + 10, 'ex_year', [
